...
import { BillUnitService } from '../services/bill-unit.service';

export class BillUnitController {

    b: BaseService;
    svBillUnit: BillUnitService;

    constructor() {
        console.log('BillController::constructor()/01')
        this.b = new BaseService();
        console.log('BillController::constructor()/02')
        this.svBillUnit = new BillUnitService();
    }
    ...
    async Create(req, res) {
        ...
        try {
            ...
            await this.svBillUnit.create(req, res);
        } catch (e) {
    ...
    async CreateSL(req, res) {
        ...
        try {
            console.log('BillController::Create()/02')
            await this.svBillUnit.createSL(req, res);
        } catch (e) {
    ...
    async Get(req, res) {
        try {
            await this.svBillUnit.getBillUnit(req, res);
        } catch (e) {
    ...
    async GetSL(req, res) {
        try {
            await this.svBillUnit.getBillUnitSL(req, res);
        } catch (e) {
    ...
    //             }
    //             catch (err) {
    //                 return await this.serviceErr(req, res, err, 'BillUnitService:read');
    //             }
    //             break;
    //         case 'count':
    //             try {
    ...
    //     // this.serviceErr(res, err, 'BillUnitService:read');
    // }
    ...
    async GetCount(req, res) {
        try {
            await this.svBillUnit.getPaged(req, res);
        } catch (e) {
            this.b.serviceErr(req, res, e, 'BillController:Get');
        }
    }
    ...
    async GetPagedSL(req, res) {
        try {
            await this.svBillUnit.getPagedSL(req, res);
        } catch (e) {
            this.b.serviceErr(req, res, e, 'BillController:GetSL');
        }
    }
    ...
    async Update(req, res) {
        ...
        try {
            ...
            await this.svBillUnit.update(req, res);
        } catch (e) {
    ...
    async Delete(req, res) {
        try {
            await this.svBillUnit.delete(req, res);
        } catch (e) {
    ...
    async GetMeta(req, res) {
        try {
            await this.svBillUnit.getMeta(req, res);
        } catch (e) {
            this.b.serviceErr(req, res, e, 'BillController:Get');
        }
    }
